...
<body>
    <div class="header-logo">
        <img src="img/logo.png" alt="Logotipo da DEVOPS Software House">
    </div>
    <div class="wrapper">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <p>Preencha este formulário e envie para adicionar o registro do empregado ao banco de dados.</p>
